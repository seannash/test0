...
// configuration step. It creates a namespace called `test0`. You can modify
...
{
  try {
    CLI::App app{ fmt::format("{} version {}", test0::cmake::project_name, test0::cmake::project_version) };
